...
namespace {
constexpr auto kDefaultSDKName{"lidar_publisher_node"};
}

namespace spot_ros2 {

LidarPublisherNode::LidarPublisherNode(std::unique_ptr<NodeInterfaceBase> node_base_interface,
                                       std::unique_ptr<SpotApi> spot_api,
                                       std::unique_ptr<LidarPublisher::MiddlewareHandle> middleware_handle,
...
void LidarPublisherNode::initialize(std::unique_ptr<SpotApi> spot_api,
                                    std::unique_ptr<LidarPublisher::MiddlewareHandle> middleware_handle,
                                    std::unique_ptr<ParameterInterfaceBase> parameter_interface,
                                    std::unique_ptr<LoggerInterfaceBase> logger_interface,
                                    std::unique_ptr<TfBroadcasterInterfaceBase> tf_broadcaster_interface,
...
std::shared_ptr<rclcpp::node_interfaces::NodeBaseInterface> LidarPublisherNode::get_node_base_interface() {
