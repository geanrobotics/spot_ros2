...
class LidarPublisherNode {
 public:
   ...
   *
   */
  LidarPublisherNode(std::unique_ptr<NodeInterfaceBase> node_base_interface, std::unique_ptr<SpotApi> spot_api,
   ...
   */
  explicit LidarPublisherNode(const rclcpp::NodeOptions& node_options = rclcpp::NodeOptions{});
 ...
 private:
  ...
  std::unique_ptr<LidarPublisher> internal_;
};
}  // namespace spot_ros2
